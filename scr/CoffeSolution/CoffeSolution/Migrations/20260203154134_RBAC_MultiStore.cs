...
{
    /// <inheritdoc />
    public partial class RBAC_MultiStore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuActions_Menus_MenuId",
                        column: x => x.MenuId,
                        principalTable: "Menus",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId = table.Column<int>(type: "int", nullable: false),
                    MenuId = table.Column<int>(type: "int", nullable: false),
                    MenuActionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleMenuPermissions_MenuActions_MenuActionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WarehouseReceipts_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_WarehouseReceipts_Users_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WarehouseReceiptDetails_WarehouseReceipts_WarehouseReceiptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleMenuPermissions_MenuActionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleMenuPermissions_RoleId_MenuId_MenuActionId",
                table: "RoleMenuPermissions",
                columns: new[] { "RoleId", "MenuId", "MenuActionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseReceiptDetails_WarehouseReceiptId",
                table: "WarehouseReceiptDetails",
                column: "WarehouseReceiptId");

            migrationBuilder.CreateIndex(
                name: "IX_WarehouseReceipts_CreatedById",
                table: "WarehouseReceipts",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_WarehouseReceipts_ReceiptCode",
                table: "WarehouseReceipts",
                column: "ReceiptCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WarehouseReceipts_StoreId",
                table: "WarehouseReceipts",
                column: "StoreId");
